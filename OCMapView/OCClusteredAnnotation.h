...
/** OCClusteredAnnotation stores all annotations which are in its area.
 ...
 */
@interface OCClusteredAnnotation : NSObject <MKAnnotation, OCGrouping>{
    NSMutableArray *annotationsInCluster;
    NSString *title;
    NSString *subtitle;
    NSString *_groupTag;
    CLLocationCoordinate2D coordinate;
    CLLocationCoordinate2D moveToCoordinate;
}
//
// Constructors
...
/** Returns all annotations in the cluster.
 READONLY
 */
@property(nonatomic) NSArray *annotationsInCluster;
@property(nonatomic, strong) UIImageView *animationImageView;
@property(nonatomic) CLLocationCoordinate2D moveToCoordinate;
